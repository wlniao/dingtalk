...
namespace Wlniao.Dingtalk
{
    ...
    public class CspaceHandler : DingtalkHandler
    {
        ...
        #region SingleUpload
        private void SingleUploadEncode(ContextOld ctx)
        {
            ...
            if (req != null)
            {
                ...
                ctx.HttpRequestBody = ClientOld.DoPost(texts, files, out contentType);
        ...
        private void SingleUploadDecode(ContextOld ctx)
        {
            try
            {
        ...
        private void AddToSingleChatEncode(ContextOld ctx)
        {
        ...
        private void AddToSingleChatDecode(ContextOld ctx)
        {
            try
            {
