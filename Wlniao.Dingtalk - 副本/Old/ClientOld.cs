...
namespace Wlniao.Dingtalk
{
    ...
    /// 企业微信内部开发客户端
    /// </summary>
    public class ClientOld : Wlniao.Handler.IClient
    {
        #region 企业内部开发配置信息
        ...
        /// 
        /// </summary>
        public ClientOld(String AppKey, String AppSecret, String ApiServer = null)
        {
            this.AppKey = AppKey;
        ...
        /// 
        /// </summary>
        public ClientOld(String CorpId, String AppKey, String AppSecret, String SuiteTicket, String ApiServer = null)
        {
            this.CorpId = CorpId;
            this.AppKey = AppKey;
            this.AppSecret = AppSecret;
        ...
        public string GetCorpToken(Boolean renew = false)
        {
            ...
            if (renew || tokens[key].past < DateTime.Now)
            {
                ...
                {
                    tokens[key].code = rlt.data.errcode.ToString();
        ...
        public string GetTicket(Boolean renew = false)
        {
            ...
            {
                var rlt = GetResponseFromAsyncTask(CallAsync<Auth.GetTicketRequest, Auth.GetTicketResponse>("getticket", new Auth.GetTicketRequest()
                {
