...
namespace Wlniao.Dingtalk
{
    ...
    public class WorkerHandler : DingtalkHandler
    {
        ...
        private void ProcessInstanceCreateEncode(ContextOld ctx)
        {
        ...
        private void ProcessInstanceCreateDecode(ContextOld ctx)
        {
            try
            {
        ...
        private void WorkRecordAddEncode(ContextOld ctx)
        {
        ...
        private void WorkRecordAddDecode(ContextOld ctx)
        {
            try
            {
        ...
        private void WorkRecordUpdateEncode(ContextOld ctx)
        {
        ...
        private void WorkRecordUpdateDecode(ContextOld ctx)
        {
            try
            {
